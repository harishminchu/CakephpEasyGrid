...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__d('cake', 'Edit Table %s', $singularHumanName), array('action' => 'grid')); ?></li>
<?php
		$done = array();
		foreach ($associations as $_type => $_data) {
			foreach ($_data as $_alias => $_details) {
				if ($_details['controller'] != $this->name && !in_array($_details['controller'], $done)) {
					...
					echo "<li>" . $this->Html->link(__d('cake', 'Edit Table %s', Inflector::humanize($_details['controller'])), array('controller' => $_details['controller'], 'action' => 'grid')) . "</li>";
